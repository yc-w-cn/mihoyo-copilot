...
import { updateOwnershipValue } from "@sr/features/ownership/apis";
import { OwnershipState } from "@sr/features/ownership/types";
...
>(
  `${SR_KEY_PREFIX}/ownership/saveOwnershipValue`,
